    ...
    <div className="min-h-screen bg-gradient-to-br from-emerald-50 via-white to-teal-50 flex items-center justify-center p-4">
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-gray-600">Entre para continuar sua jornada de saúde</p>
        </div>

        {/* Card de Login */}
        <Card className="p-8 shadow-xl border-emerald-100">
          <form onSubmit={handleLogin} className="space-y-6">
            ...
            <Button
              type="submit"
              size="lg"
              className="w-full bg-gradient-to-r from-emerald-600 to-teal-600 hover:from-emerald-700 hover:to-teal-700 text-white h-12 text-base font-semibold"
              disabled={isLoading}
            >
              {isLoading ? (
        ...
        <button
          onClick={onBack}
          className="flex items-center gap-2 text-gray-600 hover:text-gray-900 mt-6 mx-auto"
        >
